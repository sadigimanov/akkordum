...
const CHORDS_DB = {
  ...
  "Csus2(I)":{ frets: [-1, 3, 0, 0, 3, 3], fingers: [0, 1, 0, 0, 2, 2] },
  "Csus2(II)":{ frets: [-1, 3, 5, 5, 3, 3], fingers: [1, 1, 3, 4, 1, 1], barre: { fret: 3, from: 5, to: 1 } },
  "Csus2(III)":{ frets: [-1, 3, 0, 0, 1, 3], fingers: [0, 2, 0, 0, 1, 4] },
  ...
  "C#7":  { frets: [-1, 4, 6, 4, 6, 4], fingers: [0, 1, 3, 1, 4, 1], barre: { fret: 4, from: 5, to: 1 } },
  "C#m7": { frets: [-1, 4, 6, 4, 5, 4], fingers: [0, 1, 3, 1, 2, 1], barre: { fret: 4, from: 5, to: 1 } },
  ...
  "Dsus2(I)":{ frets: [-1, -1, 0, 2, 3, 0], fingers: [0, 0, 0, 1, 3, 0] },
  "Dsus2(II)":{ frets: [-1, 5, 7, 7, 5, 5], fingers: [0, 1, 3, 4, 1, 1], barre: { fret: 5, from: 5, to: 1 } },
  "Dsus4":{ frets: [-1, -1, 0, 2, 3, 3], fingers: [0, 0, 0, 1, 3, 4] },

  // ── D# / Eb ailesi ────────────────────────────────────────
  "D#":   { frets: [-1, -1, 1, 3, 4, 3], fingers: [0, 0, 1, 2, 4, 3] },
  "D#m":  { frets: [-1, 6, 8, 8, 7, 6], fingers: [0, 1, 3, 4, 2, 2], barre: { fret: 6, from: 5, to: 1 } },
  "Eb":   { frets: [-1, -1, 1, 3, 4, 3], fingers: [0, 0, 1, 2, 4, 3] },
  "Ebm":  { frets: [-1, 6, 8, 8, 7, 6], fingers: [0, 1, 3, 4, 2, 1], barre: { fret: 6, from: 5, to: 1 } },
  ...
  "F7":   { frets: [1, 3, 1, 2, 1, 1], fingers: [1, 3, 1, 2, 1, 1], barre: { fret: 1, from: 6, to: 1 } },
  "Fm7":  { frets: [1, 3, 1, 1, 1, 1], fingers: [1, 3, 1, 1, 1, 1], barre: { fret: 1, from: 6, to: 1 } },
  "Fmaj7(I)":{ frets: [-1, -1, 3, 2, 1, 0], fingers: [0, 0, 3, 2, 1, 0] },
  "Fmaj7(II)":{ frets: [1, 0, 2, 2, 1, 0], fingers: [1, 0, 3, 4, 2, 0] },
  "Fsus2(I)":{ frets: [1, 3, 3, 0, 1, 1], fingers: [1, 3, 4, 0, 2, 2] },
  "Fsus2(II)":{ frets: [-1, -1, 3, 0, 1, 1], fingers: [0, 0, 3, 0, 1, 1] },
  ...
  "F#7":  { frets: [2, 4, 2, 3, 2, 2], fingers: [1, 3, 1, 2, 1, 1], barre: { fret: 2, from: 6, to: 1 } },
  "F#m7": { frets: [2, 4, 2, 2, 2, 2], fingers: [1, 3, 1, 1, 1, 1], barre: { fret: 2, from: 6, to: 1 } },
  ...
  "Gm7":  { frets: [3, 5, 3, 3, 3, 3], fingers: [1, 3, 1, 1, 1, 1], barre: { fret: 3, from: 6, to: 1 } },
  "Gb":   { frets: [2, 4, 4, 3, 2, 2], fingers: [1, 3, 4, 2, 1, 1], barre: { fret: 2, from: 6, to: 1 } },
  "Gmaj7":{ frets: [3, 2, 0, 0, 0, 2], fingers: [3, 2, 0, 0, 0, 1] },
  "Gsus4":{ frets: [3, 3, 0, 0, 1, 3], fingers: [2, 3, 0, 0, 1, 4] },
  "Gsus2":{ frets: [3, 0, 0, 0, 3, 3], fingers: [1, 0, 0, 0, 2, 2] },

  // ── G# / Ab ailesi ────────────────────────────────────────
  "G#":   { frets: [4, 6, 6, 5, 4, 4], fingers: [1, 3, 4, 2, 1, 1], barre: { fret: 4, from: 6, to: 1 } },
  "G#m":  { frets: [4, 6, 6, 4, 4, 4], fingers: [1, 3, 4, 1, 1, 1], barre: { fret: 4, from: 6, to: 1 } },
  "Ab":   { frets: [4, 6, 6, 5, 4, 4], fingers: [1, 3, 4, 2, 1, 1], barre: { fret: 4, from: 6, to: 1 } },
  ...
  "Asus4(I)":{ frets: [-1, 0, 2, 2, 3, 0], fingers: [0, 0, 1, 2, 3, 0] },
  "Asus4(II)":{ frets: [-1, 0, 0, 2, 3, 0], fingers: [0, 0, 0, 1, 2, 0] },
